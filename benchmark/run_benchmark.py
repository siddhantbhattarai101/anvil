...
def anvil_verdict(anvil_bin, base, t, out_json):
    ...
    flag = {"sqli": "--sqli", "xss": "--xss", "ssrf": "--ssrf", "cmdi": "--cmdi", "pathtrav": "--path-traversal"}[t["type"]]
    ...
    kw = {"sqli": ["sql"], "xss": ["xss", "scripting"],
          "ssrf": ["ssrf", "request forgery"], "cmdi": ["command"], "pathtrav": ["traversal", "lfi", "file inclusion"]}[t["type"]]
    try:
